...
//This class is for creating all the songs with their attributes. Some of the attributes will appear in the screens of the JSP pages in browser mode
public class Song implements Comparable<Song>{
    
    //The private attributes of the class Song
