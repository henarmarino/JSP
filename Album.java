...
//This class is for creating all the albums with their attributes. Some of the attributes will appear in the screens of the JSP pages in browser mode
public class Album implements Comparable<Album>{

    //The private attributes of the class Album
    private String name;
    ...
    //Getters of the attributes of the class Album
